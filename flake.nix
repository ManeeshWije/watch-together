{
  ...
  outputs = {
    ...
    mkProject = system: let
      ...
      # Node 20 is EOL; Node 22 is the closest supported LTS replacement.
      ...
      backend = pkgs.rustPlatform.buildRustPackage {
        ...
        # The Dockerfile does not run tests, and application tests may require
      ...
      frontend = pkgs.buildNpmPackage {
        ...
        # Uses the integrity hashes already stored in package-lock.json.
      ...
      container = n2c.buildImage {
        ...
        # Split popular store paths into reusable layers for faster re-pushes.
        maxLayers = 100;
      ...
      devShell = pkgs.mkShell {
        packages = [
          ...
          # Local runtime and infrastructure tooling
          pkgs.postgresql
          pkgs.yt-dlp
          pkgs.python3
          pkgs.deno
